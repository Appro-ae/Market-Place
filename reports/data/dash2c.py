...
h.append('<div class="foot">Data pulled live from Jira on 26 August 2026. Raised = Bug created in project AMP between 1 and 26 August. '
 ...
 '<b>Residual audit gap:</b> the BA-scope-rewrite rule needs a per-ticket changelog read; 9 of the 141 tickets were read in full this run '
 '(AMP-3188 excluded — Phuong rewrote its summary twice and description five times after it reached Toan). '
 'The other 132 are counted on the mechanical criteria alone. '
