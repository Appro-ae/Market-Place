...
| Audit trail | 3 new steps — "Manual revert process", "Revert Queue", "Auto Revert Approval on timeout" (mirrors cancellation's "Auto Cancellation on timeout"). The original rejection record is never modified. | <img src="assets/ia_audit.png" width="290"><br>*Application history steps* |
