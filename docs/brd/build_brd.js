...
P(
  ...
  tbl(
    ['Type', 'Subject', 'Content', 'Trigger'],
    [
      ['Email (Client)', 'Reem Bank — Update on your application %%APPLICATION_ID%%', 'Dear %%CUSTOMER_NAME%%, Following a further review of your %%PRODUCT_TYPE%% application %%APPLICATION_ID%%, we are pleased to inform you that your application has been approved. No action is required from your side — we will be in touch with the next steps to complete your application. Thank you for choosing Reem Bank. Best Regards, Reem Bank', 'One time — when an application reopened via an approved revert is **approved** after re-assessment. Newly added in Communication Setup, mirroring the standard approval message.'],
      ['Email (Client)', 'Reem Bank — Update on your application %%APPLICATION_ID%%', 'Dear %%CUSTOMER_NAME%%, Following a further review of your %%PRODUCT_TYPE%% application %%APPLICATION_ID%%, we regret to inform you that your application has not been approved on this occasion. You may submit a new application after 30 days from the date of this decision. Thank you for your interest in Reem Bank. Best Regards, Reem Bank', 'One time — when an application reopened via an approved revert is **rejected again** after re-assessment (replaces the generic rejection notification for this case). Exactly one client email per re-assessment decision — one email either way.'],
    ],
    [15, 22, 40, 23],
  ),
  h2('7. Summary'),
