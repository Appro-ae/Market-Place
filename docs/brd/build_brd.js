...
P(
  ...
  new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 200 }, children: [new TextRun({ text: '18 September 2026', size: 22, color: GREY, font: FONT })] }),
