    ...
    <div>
      ...
      <div style={{ maxWidth: 620 }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, background: '#E6F9F2', border: '1px solid #A7E8CF', borderRadius: 12, padding: '16px 18px', marginBottom: 16 }}>
          ...
          <div>
            <div style={{ fontSize: 15.5, fontWeight: 700, color: '#065F46' }}>User invited — activation email sent</div>
            <div style={{ fontSize: 13.5, color: '#047857', marginTop: 3, lineHeight: 1.55 }}>{user.name} was invited with status <b>Invited</b>. An activation email has been sent to <b style={{ fontFamily: 'var(--font-mono)' }}>{user.email}</b>.</div>
          </div>
        </div>
        <Card>
          <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
            ...
            <div style={{ fontSize: 13.5, color: 'var(--ink-700)', lineHeight: 1.6 }}>
              The user receives an email from the Appro API Marketplace with a secure link to <b>set their password and activate the account</b>. The link is single-use and valid for <b>{TUR_LINK_EXPIRY_MIN} minutes</b> (configurable — BRD v1.4 · NFR-6). Opening it takes them to the Activate Account screen; once they set a password the account becomes <b>Active</b> and they can sign in to the Customer Portal with their email and password.
            </div>
          </div>
        </Card>
